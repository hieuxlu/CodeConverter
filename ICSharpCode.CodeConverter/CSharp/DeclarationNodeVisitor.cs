...
namespace ICSharpCode.CodeConverter.CSharp
{
    ...
    internal class DeclarationNodeVisitor : VBasic.VisualBasicSyntaxVisitor<Task<CSharpSyntaxNode>>
    {
        ...
        public DeclarationNodeVisitor(Project project, Compilation compilation, SemanticModel semanticModel,
            CSharpCompilation csCompilation, SyntaxGenerator csSyntaxGenerator)
        {
            ...
            CommonConversions = new CommonConversions(project, semanticModel, typeConversionAnalyzer, csSyntaxGenerator, csCompilation);
